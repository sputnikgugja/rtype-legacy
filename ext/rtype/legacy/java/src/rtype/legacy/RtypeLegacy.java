...
public class RtypeLegacy {
	public static String JAVA_EXT_VERSION = "0.0.2";
	
	public static Ruby ruby;
	public static RubyModule rtype;
	public static RubyModule rtypeLegacy;
	...
	public static void init(Ruby ruby) {
		RtypeLegacy.ruby = ruby;
		
		rtype = ruby.defineModule("Rtype");
		rtypeLegacy = ruby.defineModuleUnder("Legacy", rtype);
		...
		rtype.defineAnnotatedMethods(RtypeLegacy.class);
		rtypeLegacy.defineConstant("JAVA_EXT_VERSION", ruby.newString(JAVA_EXT_VERSION));
	}
